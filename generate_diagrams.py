...
projects = {
    "axum": ["todo-list", "weather-app", "calculator", "currency-converter", "notes-app", "chat-app", "ecommerce-platform", "task-manager", "realtime-collab", "blockchain-voting"],
    "rocket": ["recipe-app", "contact-form", "bmi-calculator", "quote-generator", "tip-calculator", "event-management", "movie-recommendation", "library-management", "home-automation", "finance-manager"],
    "actix-web": ["color-picker", "flashcard-app", "url-shortener", "lang-learning-app", "simple-chatbot", "restaurant-res", "fitness-tracker", "job-board", "healthcare-mgmt", "smart-inventory"]
}
        ...
        for name in names:
            ...
            for dtype, content in diagrams.items():
                ...
                for ext in ["png", "svg", "pdf"]:
                    ...
                    # Use a shorter timeout per mmdc call to keep stdout moving
